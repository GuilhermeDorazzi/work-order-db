 ...
 BEGIN
  ...
  `DATA_ATUALIZACAO` datetime,
    */
    ...
    /*
      INSERT INTO TB_USUARIOS_SUBORDINADOS 
              (COD_EMPRESA, COD_USUARIO, COD_FILIAL, COD_USUARIO_SUBORDINADO, DATA_CADASTRO) 
       SELECT @COD_EMPRESA, @COD_USUARIO, @COD_FILIAL, COD_USUARIO, current_timestamp() 
         FROM TB_USUARIOS 
        WHERE COD_EMPRESA = @COD_EMPRESA 
          AND COD_USUARIO != @COD_USUARIO 
          AND COD_USUARIO IN @CodsForIn
...
BEGIN
    ...
    IF V_VALOR_DESCONTO_MAXIMO > 0 AND V_PERCENTUAL_DESCONTO > 0 AND IFNULL(V_VALOR_TOTAL,0) < V_VALOR_DESCONTO_MAXIMO
        ...
        IF(V_VALOR_COTA + IFNULL(V_VALOR_TOTAL,0)) > V_VALOR_DESCONTO_MAXIMO
			THEN 
				SET V_VALOR_COTA = (V_VALOR_COTA + IFNULL(V_VALOR_TOTAL,0)) - V_VALOR_DESCONTO_MAXIMO;
		END IF;
        --
